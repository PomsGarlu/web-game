...
function updateHUD(hudContent) {
  content = `
    <div>Score: ${hudContent.score}</div>
    <div>Health: ${hudContent.health}</div>
    <div>Timer: ${hudContent.timer}</div>
    <div>Player: ${hudContent.playerName}</div>
`;
